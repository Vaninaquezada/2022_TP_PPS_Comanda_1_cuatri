...
import { EncuentaSupervisorClienteComponent } from 'src/app/componentes/encuenta-supervisor-cliente/encuenta-supervisor-cliente.component';
...
export class ListaClientesPage implements OnInit {
  ...
  async presentModal(usuario: User) {
    const modal = await this.modal.create({
      component: EncuentaSupervisorClienteComponent,
      swipeToClose: true,
