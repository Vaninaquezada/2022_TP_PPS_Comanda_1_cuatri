...
@Component({
  selector: 'app-encuenta-grafico-pie',
  templateUrl: './encuenta-grafico-pie.component.html',
  styleUrls: ['./encuenta-grafico-pie.component.scss'],
})
export class EncuentaGraficoPieComponent implements OnInit,AfterViewInit {
