...
import { AnimationKeyFrame } from '@ionic/core/dist/types/utils/animation/animation-interface';
import { Chart, ChartTypeRegistry, registerables } from 'chart.js';
import { AuthService } from 'src/app/services/auth.service';


@Component({
  selector: 'app-encuenta-grafico-barras',
  templateUrl: './encuenta-grafico-barras.component.html',
  styleUrls: ['./encuenta-grafico-barras.component.scss'],
})
export class EncuentaGraficoBarrasComponent implements OnInit,AfterViewInit {
...
this.titulo= this.navParams.data.preguntaText;
    console.log(this.navParams.data.respuesta);
