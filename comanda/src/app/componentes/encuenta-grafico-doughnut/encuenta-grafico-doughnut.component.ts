...
@Component({
  selector: 'app-encuenta-grafico-doughnut',
  templateUrl: './encuenta-grafico-doughnut.component.html',
  styleUrls: ['./encuenta-grafico-doughnut.component.scss'],
})
export class EncuentaGraficoDoughnutComponent implements OnInit,AfterViewInit {
